...
st.subheader("Cleaning The Data :shower:")
with st.expander("Click to See the Code Cleaning Process."):
    st.header("Cleaning The Data in Jupyter Notebooks")

    st.code('''
    # Import the datasets and merge them into one dataframe
    import pandas as pd 
    import numpy as np
    ...
    # Only np.null was found 
    # Replaced it with pd.Na
    ...
    st.code(''' 
    # Appends the number from the years seperately for the degree_length 
    # Example "4 years" become "4" as an integer of course 
...
st.subheader("Project Code File :computer:")
with st.expander("Click to see main code for the project."):
    st.code('''
